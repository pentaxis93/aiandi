...
```
IDEA → RESEARCH → WALK → OUTLINE → DRAFT → VOICE → TECHNICAL → POLISH → SLEEP → PROOF → PUBLISH
```
...
|---|------|-------|-----------|-----|
| 001 | `56-beginner` | 56, Beginner | 2026-01-19 | `/blog/001-56-beginner` |
| 002 | `the-seed-grew-anyway` | The Seed Grew Anyway | 2026-01-19 | `/blog/002-the-seed-grew-anyway` |
